...
export function BlogCard({
  ...
  return (
    <motion.article
      ...
      whileHover={{ y: -6 }}
    >
      <Card className="group h-full border-border/50 bg-card/40 backdrop-blur-sm transition-all duration-300 hover:border-orange-500/40 hover:shadow-lg hover:shadow-orange-500/5">
