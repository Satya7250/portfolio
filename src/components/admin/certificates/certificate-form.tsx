...
export function CertificateForm({ certificate, onSaved, onCancel }: CertificateFormProps) {
  ...
  const [isPublished, setIsPublished] = React.useState(certificate?.isPublished ?? true);
